...
### Spawn contract + host-loop vs VM-loop (binary-verified through asar 1.17377.1; asar analysis since carried through 1.18286.2 — the full spawn contract is byte-identical across the 1.18286.0→1.18286.2 bump — the live end-to-end pass remains pinned to 1.17377.1)
