...
| [critique.md](./critique.md) | **EXPERIMENTAL** — `critique`: run a skill, ask the agent what confused it, then grade that self-report against a frozen record. Confabulation resistance, cost, exit codes, and the limits when the skill is not yours. |
