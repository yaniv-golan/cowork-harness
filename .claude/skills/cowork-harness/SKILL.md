...
metadata:
  ...
  version: 0.18.0
  tracks-harness: cowork-harness 0.18.0 (baseline desktop-1.15962.0)
---
...
> **Version note:** the facts and `file:line` pointers here track `cowork-harness 0.18.0` (baseline
