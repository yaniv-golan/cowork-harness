...
metadata:
  ...
  version: 0.27.0
  tracks-harness: cowork-harness 0.27.0 (baseline desktop-1.18286.2)
---
...
- **A run failed — or greened and you don't trust it** (the debugging loop) → don't re-run and hope.
  ...
  the loop 0.27.0's observability is built for; the *Triage* and *Inspecting a run's observability
