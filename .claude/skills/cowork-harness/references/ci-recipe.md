...
Self-contained reference. Tracks `cowork-harness 1.0.5` (baseline `desktop-1.20186.1`).
...
release; pin an exact version (e.g. `version: "1.0.5"`) for reproducible CI.
...
```yaml
- run: npm i -g "cowork-harness@>=1.0.5"
