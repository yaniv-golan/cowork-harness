...
Tracks `cowork-harness 3.2.0` (baseline `desktop-1.40609.1`), same as SKILL.md's front-matter. Recipe 2's `resolved-tier`/`unverifiable-tier` staleness classes and
