...
Self-contained reference for authoring `cowork-harness` scenarios. Tracks `cowork-harness 0.18.0`
(baseline `desktop-1.15962.0`). If your checkout is newer, prefer the live `docs/scenario.md`,
